...
| applyOnForward    | Indicates to apply the rules in this policy on forward traffic.                                                                                          | true, false     | boolean               | false   |

The `doNotTrack`, `preDNAT` and `applyOnForward` fields are meaningful only when applying policy to a
